...
#
# REGENERATED 2026-09-14 from pit_dashboard.py at commit bde0877. That version
# added two metrics the earlier extraction never had: Throttle and Solar
# Current.
#
...
HISTORY_CHARTS = [
    ...
    # What the array put into the pack. Overlay on Total Race Energy and the
    # night/day balance of a 24-hour run reads straight off the chart.
    Metric("SolarCurrent", "Solar Current", "A", "#ffd166",
