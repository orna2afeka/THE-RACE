...
_KNOWN_LIMITS = {
    ...
    "BATT_CURRENT", "MOTOR_CURRENT", "POWER", "SPEED", "SOLAR_CURRENT",
    "CELL_VOLTAGE",
}

# Derived values resolve() computes by name.
_KNOWN_DERIVED = {
    "delta_to_target", "solar_status", "relative_regen_total",
...
LIVE_METRIC_GROUPS = [
    ...
    ("Battery", [
        ...
        dict(label="Solar Current", unit="A", spec="+.2f", limit="SOLAR_CURRENT", field="state.solar_current",
             note="MPPT into the pack; Yocto-Amp, 10 A max"),
        dict(label="Solar Sensor", unit="", spec=".0f", derived="solar_status", text=True,
