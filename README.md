...
│   └── lap93_293s.csv   4:53   the ONLY profile, and the car's default: race
│                                  lap 93 (2026-09-19) exactly as driven
│
...
│                                     #   --demo drives it from lap93_293s.csv with no database at all
│
