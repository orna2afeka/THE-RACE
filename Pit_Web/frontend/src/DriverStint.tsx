...
import { hms, hmsSigned, postJSON } from './lib';
...
export function StintClock({ stint, serverNowS }: { stint: Stint | undefined; serverNowS: number }) {
...
export function StintBanner({ stint, serverNowS }: { stint: Stint | undefined; serverNowS: number }) {
  const n = stintNow(stint, serverNowS);
...
export function StintPanel({ stint, serverNowS, racing }: {
  stint: Stint | undefined; serverNowS: number; racing: boolean;
}) {
