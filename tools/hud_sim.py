...
what you see here is what the driver sees — layout, colours, thresholds and all.
    ...
    python tools/hud_sim.py --profile lap93_293s
...
def main() -> int:
    ...
    ap.add_argument("--profile", default=None,
                    help="profile name from profiles/ (default: lap93_293s)")
    ...
    if not available:
        ...
        return 1
    name = args.profile or ("lap93_293s" if "lap93_293s" in available
