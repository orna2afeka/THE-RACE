...
reads:
    ...
    profiles/lap93_293s.csv    the 280 s baseline lap the demo car actually drives
...
PROFILE_PATH = os.path.join(_REPO, "profiles", "lap93_293s.csv")
...
def build_data():
    ...
    return {
        ...
        # drives profiles/lap93_293s.csv, built from a lap the car logged, whose
